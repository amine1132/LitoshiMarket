      ...
      <div className="inscription_2">
        ...
        <div className="inscription_groupe1">
          ...
          <div className="inscription_center2">
            ...
            <div className="inscription_search2"></div>
          </div>
        </div>
