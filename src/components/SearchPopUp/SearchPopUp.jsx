    ...
    <div className="bg-black bg-opacity-50 fixed inset-0 justify-center flex z-10">
        <div className={`h-[520px] w-[750px] self-center p-4 rounded-3xl bg-[#1E1E1F]`}>
            ...
            <div className="bg-[#151516] p-2 flex rounded-lg border border-white border-opacity-10">
                ...
                <input type="text" placeholder="Search" className="text-left placeholder:text-white placeholder:opacity-50 ml-2" />
                <button onClick={handleSearchPopUp} className={`rounded-lg w-full flex justify-end`}>
                    <img src="/src/assets/cross.png" alt="" className="opacity-50 w-[12px] h-[12px] self-center mr-2"/>
                </button>
            </div>
            ...
            <div className="flex mt-5 text-xl">
                <p className="text-[#FD5A00] mr-1">Trending</p>
                <p>on Litoshi</p>
            </div>
