    ...
    return (
        ...
        >
            <div className={`flex`}>
                ...
                <div className="pl-5 self-center">
                    <h1 className="pb-2 text-2xl flex">
                        Yaugourt
                        <img src="/src/assets/color-pencil.png" className="pl-3 pt-2 h-[30px]" alt="" />
                    </h1>
                    <p className="pl-1 mb-10 flex items-center">
                        <small id="adress">bc1par0t76nmjf55wp0rpzu58p97mzz6tf3cd67js077a2qx5ez8knlqfnccjq</small>
                        <img
            ...
            <div className="flex pt-5 justify-between gap-x-[5%] w-full">
                <button className={`w-[220px] py-2 rounded-lg bg-[#151516] flex justify-center items-center gap-3`}>
                    <img src={twitter} alt="" />
                    Twitter
                </button>
