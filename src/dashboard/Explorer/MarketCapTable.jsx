          ...
          <tbody className="semi">
            {currentItems.map((token, index) => (
              ...
              >
                ...
                >
                  {token.min_listed_unit_price
                    ? parseFloat(token.min_listed_unit_price).toLocaleString(
                        "en-US",
                        {
                          style: "currency",
                          currency: "USD",
                ...
                <td
                  className={`${
                    token.holder_count ? "text-white-500" : "text-gray-500"
                  } ${
                    index != itemsPerPage - 1 && `border-b border-[#151516]`
                  }`}
                >
                ...
                <td
                  className={`${
                    token.vol_1d && parseFloat(token.vol_1d) < 0
                      ? "text-red-500"
                      : token.vol_1d && parseFloat(token.vol_1d) > 0
                      ? "text-green-500"
                      : "text-gray-500"
                ...
                >
                  {token.vol_1d
                    ? (parseFloat(token.vol_1d) >= 0 ? "+" : "") +
                      parseFloat(token.vol_1d).toFixed(2) +
                      "%"
                    : "N/A"}
                </td>
                ...
                <td
                  className={`${
                    token.tx_count ? "text-white-500" : "text-gray-500"
                  } ${
                    index != itemsPerPage - 1 && `border-b border-[#151516]`
                  }`}
                >
                ...
                <td
                  className={`${
                    token.sale_count ? "text-white-500" : "text-gray-500"
                  } ${
                    index != itemsPerPage - 1 && `border-b border-[#151516]`
                  }`}
                >
