...
<div className="menu"> 
  ...
  <button className='connect'onClick={requestAccounts}> <img src={Footer} alt=""/>Wallet login</button>
  <p className='section'>Your profile</p>
    ...
    <div className='menuv1'>
      <button className='BRC'><img src={globalsearch} alt=""/>Overview</button>
      <button className='BRC2'><img src={Bitcoin} alt=""/>BRC-20</button>
      <button className='LTC'><img src={litecoinltclogo} alt=""/>LTC-20</button>
      <button className='DRC'><img src={dogecoindogelogo} alt=""/>DRC-20</button>
    </div>
  </div>
